...
type LastfmParams = Record<string, string | number | boolean | undefined>;
...
export function trackUpdateNowPlaying(params: LastfmParams) {
...
export function trackScrobble(params: LastfmParams) {
  params.api_key = apiKey;
