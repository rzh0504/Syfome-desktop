// Navidrome 不提供 MV 能力，保留接口以兼容旧调用。
 ...
 */
export function mvDetail(mvid: string | number) {
...
export function mvUrl() {
  return Promise.resolve({ code: 501, data: { url: '' } });
}
...
export function likeAMV() {
  return Promise.resolve({ code: 501 });
}
